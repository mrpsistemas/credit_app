...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">Clientes /</span> Creación</h4>
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="card">                
                    <div class="card-body">
                      <form id="formValidationExamples" class="row g-3" method="POST" action="{{ route('register') }}">
                        @csrf
                        ...
                        @if(! tenancy()->tenant)
                          <!-- Company -->
                          <div class="col-md-3">
                            <label class="form-label" for="formValidationCompany">Nombre de la Empresa o Negocio</label>
                            <input
                              type="text"
                              id="formValidationCompany"
                              class="form-control"
                              placeholder="MRP sistemas Inc."
                              name="company"
